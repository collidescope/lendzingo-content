...
const solutions = [
  ...
  },
  {
    ...
    card: {
      ...
      ctaHref: 'https://myRefinanceCompanion.com',
    },
  },
  {
    id: 'personal-loan',
    ...
    card: {
      ...
      ctaText: 'Check My Rate →',
      ctaHref: 'https://myPersonalLoanCompanion.com',
    },
  },
  {
    ...
    card: {
      ...
      detail: 'Fixed rate · Single monthly payment · Clear payoff timeline',
